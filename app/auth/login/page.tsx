      ...
      <div className="w-full max-w-sm relative z-10 fade-in">
        ...
        <div className="surface rounded-xl p-6">
          ...
          <button
            ...
            className="w-full bg-white hover:bg-gray-50 disabled:bg-white/50 text-gray-700 py-2.5 text-sm font-medium rounded-md transition-colors duration-150 flex items-center justify-center gap-3 border border-gray-200"
          >
            {googleLoading ? (
              <>
