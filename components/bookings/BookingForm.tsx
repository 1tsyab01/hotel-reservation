        ...
        <div>
          ...
          <div className="relative">
            <Input
              ...
              className="bg-[#1A1A1A] border-[#2A2A2A] text-white text-sm focus:border-[#6366F1] [color-scheme:dark] [&::-webkit-calendar-picker-indicator]:absolute [&::-webkit-calendar-picker-indicator]:left-2.5 [&::-webkit-calendar-picker-indicator]:opacity-30 pl-8"
            />
          </div>
        </div>
        <div>
